<?php
// MySQL Database Connection Class | @access public | @package SPLIB
class MySQL
{
    ...
    * @param $sql string the database query to run | @return MySQLResult | @access public
    */
    function query($sql)
	{
...
class MySQLResult		
{
    var $mysql;			// Instance of MySQL providing database connection	| @access private | @var MySQL
    var $query;			// Query resource 									| @access private | @var resource
    ...
    */
    ...
    function size () { return mysql_num_rows($this->query); }

	// Returns the ID of the last row inserted | @return int | @access public
    function insertID () { return mysql_insert_id($this->mysql->dbConn); }
    
	// Checks for MySQL errors | @return boolean | @access public
    function isError () { return $this->mysql->isError(); }
}
?>